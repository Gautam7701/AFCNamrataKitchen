...
const reviews = [
  ...
  { name: "Sunita K.", text: "Amazing food, fast delivery, and the cheese delight is absolutely heavenly. Highly recommend!", stars: 4 },
  { name: "Ayush G.", text: "Ordered thali from the website — quality was really good and quantity was perfect. Worth it.", stars: 5 },
  { name: "Gautam K.", text: "Packaging was neat and food tasted fresh. Felt like proper homemade, not like outside food.", stars: 4 },
